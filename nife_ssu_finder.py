...
def extract_gene_neighbourhood(
    ...
    # get a gene list WITHOUT maturation genes, for smaller fasta file extraction
    ...
    # get a gene list WITH ONLY relevant PPI candidates for even smaller fasta file candidates
    ...
    if args.kofam_only:
        gff_outpath = (
            Path(output_dir)
            / gene_name
            / f"{gene_name}-gene_neighbours_KOfam_annotations.gff"
        )
    elif args.pfam_only:
        gff_outpath = (
            Path(output_dir)
            / gene_name
            / f"{gene_name}-gene_neighbours_Pfam_annotations.gff"
        )
    elif args.cogfun_only:
        gff_outpath = (
            Path(output_dir)
            / gene_name
            / f"{gene_name}-gene_neighbours_COGFUN_annotations.gff"
        )
        ...
        gff_outpath = (
            Path(output_dir)
            / gene_name
            / f"{gene_name}-gene_neighbours_combined_annotations.gff"
        )
